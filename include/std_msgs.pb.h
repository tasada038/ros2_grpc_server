...
PROTOBUF_NAMESPACE_OPEN
template<> ::robot_service::Float32* Arena::CreateMaybeMessage<::robot_service::Float32>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace robot_service {
...
class Float32 final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:robot_service.Float32) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:robot_service.Float32)
 private:
  class _Internal;
...
inline float Float32::data() const {
  // @@protoc_insertion_point(field_get:robot_service.Float32.data)
...
inline void Float32::set_data(float value) {
  ...
  // @@protoc_insertion_point(field_set:robot_service.Float32.data)
}
